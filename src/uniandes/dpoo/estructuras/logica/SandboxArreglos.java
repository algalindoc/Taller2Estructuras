...
public class SandboxArreglos {
    ...
    public void agregarEntero(int entero) {
        int[] arregloEnterosCopia = Arrays.copyOf(arregloEnteros, arregloEnteros.length + 1);

        arregloEnterosCopia[arregloEnteros.length] = entero;
        arregloEnteros = arregloEnterosCopia;
    }
    ...
    public void agregarCadena(String cadena) {
        String[] arregloCadenasCopia = Arrays.copyOf(arregloCadenas, arregloCadenas.length + 1);

        arregloCadenasCopia[arregloCadenas.length] = cadena;
        arregloCadenas = arregloCadenasCopia;
    }
    ...
    public void eliminarEntero(int valor) {
        ...
        arregloEnteros = Arrays.copyOf(arregloEnteros, newSize);
    }
    ...
    public void eliminarCadena(String cadena) {
        ...
        arregloCadenas = Arrays.copyOf(arregloCadenas, newSize);
    }
    ...
    public boolean mismosEnteros(int[] otroArreglo) {
        ...
        int[] arregloEnterosCopia = arregloEnteros.clone();
        int[] otroArregloCopia = otroArreglo.clone();

        Arrays.sort(arregloEnterosCopia);
        Arrays.sort(otroArregloCopia);

        return Arrays.equals(arregloEnterosCopia, otroArregloCopia);
    }
