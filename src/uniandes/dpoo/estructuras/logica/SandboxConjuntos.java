...
public class SandboxConjuntos {
    ...
    public List<String> getCadenasComoListaInvertida() {
        NavigableSet<String> descendente = arbolCadenas.descendingSet();
        return new ArrayList<>(descendente);
    }
    ...
    public void eliminarCadenaSinMayusculasOMinusculas(String cadena) {
        ...
        arbolCadenas.removeIf(str -> str.toLowerCase().equals(cadenaLowerCase));
    }
    ...
    public void volverMayusculas() {
        ...
        for (String cadena : arbolCadenas) {
            nuevoArbol.add(cadena.toUpperCase(Locale.getDefault()));
        }
